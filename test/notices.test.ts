 ...
 * @description Tests for PluginNotices mute and reuse behavior (via SmartConnectionsNotices re-export)
 */

import { beforeEach, describe, expect, it, vi } from 'vitest';
import { NOTICE_CATALOG, SmartConnectionsNotices } from '../src/domain/notices';
...
describe('SmartConnectionsNotices', () => {
	...
	let notices: InstanceType<typeof SmartConnectionsNotices>;

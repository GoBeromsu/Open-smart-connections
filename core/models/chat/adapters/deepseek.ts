...
export class SmartChatModelDeepseekAdapter extends SmartChatModelApiAdapter {
   ...
   */
  get req_adapter(): typeof SmartChatModelDeepseekRequestAdapter {
   ...
   */
  get res_adapter(): typeof SmartChatModelDeepseekResponseAdapter {
   ...
   * @param {any} model_data - Raw JSON from DeepSeek
   ...
   * @param {any} event - SSE event with data
...
export class SmartChatModelDeepseekRequestAdapter extends SmartChatModelRequestAdapter {
   ...
   * @returns {any} Request parameters
   */
